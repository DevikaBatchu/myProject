...
public class GLayout {
	...
	public static void main(String[] args) {
		...
		// create a Grid Layout with two columns of different size
		GridLayout gLayout = new GridLayout(2,false);
		
		// set Layout to the shell
		...
		// create a new layout data
		GridData data = new GridData(SWT.FILL, SWT.TOP, true, false, 1, 2); 
		label2.setLayoutData(data);
		
		// create a new label which is used as a separator
        label2 = new Label(shell, SWT.SEPARATOR | SWT.HORIZONTAL);
